...
interface mst_if_axil#(
  ...
  clocking cb @(posedge aclk);
    input arstn;
    input awready , wready , bvalid , bresp , arready , rvalid , rdata , rresp , rid , bid;
...
interface slv_if_axil#(
  ...
  clocking cb @(posedge aclk);
    ...
    output awready , wready , bvalid , bresp , arready , rvalid , rdata , rresp , rid , bid;
  endclocking 
endinterface
...
interface mnt_if_axil#(
  ...
  input arstn;
  input awvalid , awaddr , awport , wvalid , wdata , wstrb , bready , arvalid , araddr , arport , rready;
  input awready , wready , bvalid , bresp , arready , rvalid , rdata , rresp , bid , rid;
  endclocking
endinterface